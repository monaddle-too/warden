...
func (f *fakeService) kind() string     { return "fake agent" }
func (f *fakeService) label() string    { return "com.example.warden" }
func (f *fakeService) unitPath() string { return filepath.Join(f.dir, "com.example.warden.plist") }
