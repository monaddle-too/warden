...
Progress: inspected existing Google sharing, trusted sandbox leases, and GitHub installation broker. Existing configured account is punished-monaddle; discovery must verify that account against GitHub's installation response. Repositories outside the app installation require installation configuration before sharing.
